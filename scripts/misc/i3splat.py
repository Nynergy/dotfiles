...
def firefox(urls):
    ...
    return App(xClass="Firefox", command=_cmd(browser + urls))
...
def webcam():
    return App(command=_cmd(["mpv", "--profile=low-latency", "--untimed", "--vf=hflip", "/dev/video0"]), xClass="Webcam")
